...
Unfortunately, scripts in package.json can't be commented inline because the JSON spec doesn't spport comments, so I'm providing info on what each script in package.json does here.
